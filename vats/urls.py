...
urlpatterns = [
    ...
    path('ticket_rate/<int:id>', views.ticket_rate, name='ticket_rate'),
    path('ticket_bulk_action/', views.ticket_bulk_action, name='ticket_bulk_action'),
    path('my_tickets/', views.my_tickets, name='my_tickets'),
    path('notification/<int:id>/', views.notification_open, name='notification_open'),
